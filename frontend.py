...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listView = QtWidgets.QListView(self.todos_tab)
        ...
        self.add_todo_btn = QtWidgets.QPushButton(self.todos_tab)
        ...
        self.delete_todo = QtWidgets.QPushButton(self.todos_tab)
        ...
        self.listView_2 = QtWidgets.QListView(self.tasks_done_tab)
